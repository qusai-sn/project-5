...
namespace E_voting_System.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        public ActionResult candidatesAPP()
        {
            ...
            // Assuming 'list' is an object that has the 'list_Candidates' property
            int number = 0;

            if (!string.IsNullOrEmpty(list?.list_Candidates))
            {
                int.TryParse(list.list_Candidates, out number);
            }
